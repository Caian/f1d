...
TEST(Struct1FieldsTest, AccessCountMetadata)
{
    ...
    EXPECT_EQ(static_cast<unsigned int>(
        test::my_struct_1::num_fields),
        static_cast<unsigned int>(test::traits::
        num_fields<test::my_struct_1>::value));
}
...
TEST(Struct1FieldsTest, AccessTraits)
{
    ...
    EXPECT_EQ(typeid(test::types::field1_f), typeid(test::traits::field_wrapper_type<test::my_struct_1, 0>::type));
}
 ...
 */
TEST(Struct1FieldsTest, ApplyMethod)
{
    const double v1 = 10;

    test::my_struct_1 ms1;
    test::my_struct_1 ms2;
    test::my_struct_1 ms3;
    test::my_struct_1 ms4;
    test::my_struct_1_factory f;
    ...
    const test::funct_1_1 f1;
    const test::funct_1_2 f2;
    test::funct_1_3 f3;
    test::funct_1_4 f4;
 ...
 */
TEST(Struct1FieldsTest, CApplyMethod)
{
    const double v1 = 10;
    ...
    const test::my_struct_1 ms1 = f.get();
    const test::my_struct_1 ms3 = f.get();
